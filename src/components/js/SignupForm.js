...
const SignupForm = () => {
  ...
  const sendRequest = async () => {
    try {
      const res = await axios.post('https://bloggify-backend.onrender.com/api/user/signup', {
        name: inputs.name,
  ...
  const handleSubmit = async (e) => {
    ...
    if (step === 'signup') {
      ...
      try {
        const res = await axios.post('https://bloggify-backend.onrender.com/api/user/verify-otp', {
          email: inputs.email,
          otp: inputs.otp,
        });
